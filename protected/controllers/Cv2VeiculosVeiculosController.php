...
class Cv2VeiculosVeiculosController extends Controller
{
	/**
         ...
         public function accessRules()
 {
  ...
  $this->performAjaxValidation(array($veiculos,$carros)); 
   ...
   $veiculos->id_tipo = 1;
   $veiculos->id_vendedor = Yii::app()->user->getVendedor();
   ...
   if($veiculos->validate()){ 
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Cv2VeiculosVeiculos']))
		{
			$model->attributes=$_POST['Cv2VeiculosVeiculos'];
			if($model->save())
